"""
Workflow state definitions for the Memory-Augmented Course Q&A Agent.

Extends Stage 4 state with working memory fields for multi-turn conversations.
"""
...
class WorkflowState(TypedDict):
    """
    State for Memory-Augmented Course Q&A workflow.

    Extends Stage 4 with working memory for multi-turn conversations.
    """
