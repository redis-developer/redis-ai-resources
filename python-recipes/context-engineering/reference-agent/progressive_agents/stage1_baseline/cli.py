...
from progressive_agents.stage1_baseline.agent import BaselineRAGAgent, BaselineAgentConfig
...
class Stage1CLI:
    ...
    async def run_chat(self):
        ...
        # Welcome message
        welcome_panel = Panel(
            "[bold blue]Stage 1: Baseline RAG Agent[/bold blue]\n\n"
...
def main(model: str, max_results: int):
    """
    Stage 1: Baseline RAG Agent CLI
